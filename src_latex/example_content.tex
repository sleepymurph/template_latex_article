...
The \lstinline{plaintext} environment ignores TeX control characters,
but still typesets paragraphs.

\begin{plaintext}
    This text includes TeX control characters like %, &, or $ without escaping them.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{../generated_components/diagram_example}
...
]{../src_graphviz/diagram_example.dot}
