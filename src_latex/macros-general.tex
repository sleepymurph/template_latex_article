...
%
% Note that the Git log is a separate plaintext document, 'generated_git_log.txt',
...
\newcommand{\documenthistory}{
    ...
    {
        \input{../generated_components/generated_git_metadata.tex}
        ...
        Recent history:
        \lstinputlisting{../generated_components/generated_git_log.txt}
